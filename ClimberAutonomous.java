...
public class ClimberAutonomous extends LinearOpMode {
    ...
    public void Drive(int Distance,int Direction) {
        ...
        double ROTATIONS = Inches / 16; // Number of rotations to drive
        double TARGET = ENCODER_CPR * ROTATIONS * Direction; // Number of encoder counts to drive
...
*/
    /*
    public void TurnToLine (int Direction){

        opticalDistanceSensor.enableLed(true);
            telemetry.addData("Light Value", opticalDistanceSensor.getLightDetected());
            if (Direction < 0) {
                do {
                    //LeftDrive1.setPower(-0.2);
                    //LeftDrive2.setPower(-0.7);
                    RightDrive1.setPower(0.3);
                    //RightDrive2.setPower(0.7);
                    } while (opticalDistanceSensor.getLightDetected() <= 0.2);
    ...
    */
        ...
        // This is the BrakeBlock method. It sets the drive train to 0 power.
        public void BrakeBlock() {
            LeftDrive1.setPower(0);
            //LeftDrive2.setPower(0);
            RightDrive1.setPower(0);
            //RightDrive2.setPower(0);
